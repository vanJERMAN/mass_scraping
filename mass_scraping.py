...
try:
	...
	def scraping():    
		...
		with open("/Users/erik/Desktop/PYTHON/CSV/beautiful_soup/csv_in_xlsx_datoteke/mass_data.csv", "w") as csv_file:
		...
		while pages:
			...
			with open("/Users/erik/Desktop/PYTHON/CSV/beautiful_soup/csv_in_xlsx_datoteke/mass_data.csv", "a") as csv_file:
				csv_writer = writer(csv_file)
				rand = randint(5, 10)
				...
				for article in articles:
					...
					file_path = "/Users/erik/Desktop/PYTHON/CSV/beautiful_soup/slike/"
					url = article.find("img")["data-src"]
					filename = url[-22:]
					full_path = f"{file_path}{filename}"
					file_path_check = f"/Users/erik/Desktop/PYTHON/CSV/beautiful_soup/slike/{filename}"
		...
		# print(linki)
		read_file = pd.read_csv (r"/Users/erik/Desktop/PYTHON/CSV/beautiful_soup/csv_in_xlsx_datoteke/mass_data.csv")
		read_file.to_excel (rf"/Users/erik/Desktop/PYTHON/CSV/beautiful_soup/csv_in_xlsx_datoteke/{datum}.xlsx", index = None, header=True)
	...
	try:
		print("Trying again to run mass_scraping.py")
		scraping()
	except Exception as error:
		posiljanje("vanjermancek@gmail.com", "There was an error while running mass_scraping.py", f"{error}")
